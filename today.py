...
USER_NAME = os.environ['USER_NAME'] # 'nawrigh7'
...
if __name__ == '__main__':
    """
    Nicholas Wright (nawrigh7), 2019-2026
    """
    print('Calculation times:')
    # define global variable for owner ID and calculate user's creation date
    # e.g {'id': 'MDQ6VXNlcjU3MzMxMTM0'} and 2019-11-03T21:15:07Z for username 'nawrigh7'
    ...
    if OWNER_ID == {'id': 'MDQ6VXNlcjU3MzMxMTM0'}: # only calculate for user nawrigh7
